...
public:
    ...
    */
    double segmentBitmap(int beginCol, int beginRow, int _col, int _row);
    double ac_segmentBitmap(int beginCol, int beginRow, int _col, int _row);
    /*
    ...
    */
    double binaryzationBitmap(int value);
    double ac_binaryzationBitmap(int value);
    /*
        createBitmap():
